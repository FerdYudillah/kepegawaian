            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="serti_ukppi"> Sertifikat Lulus UKPPI</label>
                                    <input type="file" class="form-control col-4 @error('serti_ukppi') is-invalid @enderror" id="serti_ukppi" name="serti_ukppi" >
                                    @error('serti_ukppi')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="uraian_tugas"> Uraian Tugas</label>
                                    <input type="file" class="form-control col-4 @error('uraian_tugas') is-invalid @enderror" id="uraian_tugas" name="uraian_tugas" >
                                    @error('uraian_tugas')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="surat_belajar"> Surat Izin Beljar</label>
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="akreditasi_prodi">Akreditasi Prodi</label>
                                    <input type="file" class="form-control col-4 @error('akreditasi_prodi') is-invalid @enderror" id="akreditasi_prodi" name="akreditasi_prodi" >
